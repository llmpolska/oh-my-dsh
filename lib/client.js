    ...
    function OhMyDshSection() {
      ...
      return e('div', { style: C.section },
        ...
        e(Card, {
          ...
          desc: 'The model used by omd_image and /omd image. Pick a registered provider and a model id (e.g. gpt-5.6-luna on opencode-go) — the plugin reuses the provider\'s own route and API key and calls the model like a regular chat model that can emit images. "Custom endpoint" is the manual fallback.',
        },
          e('div', { style: C.grid },
            e(Field, { label: 'Provider' },
