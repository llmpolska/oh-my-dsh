    ...
    safeRegister('prompt section', () => systemPrompt.section({
      ...
      text: function () {
        ...
        return [
          ...
          '- `/omd vision [on|off]` — toggle automatic vision routing.',
          ...
          '- Messages that contain images automatically route this session to the vision tier; the session returns to its tier on the next text message.',
